...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '雪念冰', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '努力学习.png', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.xuenianbing.com', // 网站地址
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '豫ICP备2024067570号', // 备案号 闽ICP备XXXXXXX
